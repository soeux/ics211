...
public class SortableBeerListTest {
    ...
    public void initialize() {
        ...
        pils = new Pilsner[3];
        pils[0] = (Pilsner) brewery.brewPilsner("pils1", 25, 4.2);
        pils[1] = (Pilsner) brewery.brewPilsner("pils2", 30, 5.0);
        pils[2] = (Pilsner) brewery.brewPilsner("pils2", 35, 6.0);
        bitters = new SortableBeerList(ibuC);
        strongs = new SortableBeerList(abvC);
        for (int i = pils.length - 1; i >= 0; i--) {
            bitters.add(pils[i]);
            strongs.add(brewery.brewBeer("strong beer" + i, brewery.randomBeerType()));
        }
    }
    ...
    /**
     * Test method for {@link edu.ics211.h04.SortableBeerList#set(int, edu.ics211.h02.Beer)}.
     */
    @Test
    public void testSet() {
    ...
    public void testIndexOf() {
        IndiaPaleAle ipa = (IndiaPaleAle) brewery.brewBeer("IPA", BeerType.INDIA_PALE_ALE);
    ...
    /**
     * Test method for {@link edu.ics211.h04.SortableBeerList#add(edu.ics211.h02.Beer)}.
     */
    @Test
    public void testAddBeer() {
        ...
        assertEquals(ipa, bitters.get(3));
    }


    /**
     * Test method for {@link edu.ics211.h04.SortableBeerList#add(int, edu.ics211.h02.Beer)}.
     */
    @Test
