...
public class HexadecimalSudokuTest {
    ...
    public static void main(String[] arg) {
        ...
        int[][] solution3 = {{15, 4, 13, 2, 8, 5, 3, 0, 7, 12, 1, 14, 6, 10, 9, 11},
                {8, 5, 10, 6, 14, 2, 9, 11, 0, 4, 15, 13, 7, 1, 3, 12},
                {9, 7, 11, 3, 1, 12, 4, 15, 8, 5, 6, 10, 13, 2, 0, 14},
                {13, 8, 5, 4, 0, 15, 11, 14, 6, 3, 10, 12, 2, 9, 7, 1},
                {11, 0, 7, 15, 12, 1, 5, 13, 14, 2, 9, 8, 4, 3, 10, 6},
                {10, 6, 14, 1, 3, 7, 2, 9, 4, 13, 11, 0, 12, 5, 8, 15},
                {2, 3, 12, 9, 10, 4, 6, 8, 1, 15, 7, 5, 14, 11, 13, 0},
                {7, 1, 4, 0, 15, 8, 14, 2, 11, 10, 13, 9, 5, 6, 12, 3},
                {14, 15, 2, 11, 5, 9, 10, 3, 12, 0, 8, 6, 1, 7, 4, 13},
                {12, 13, 8, 10, 4, 11, 1, 6, 5, 14, 3, 7, 15, 0, 2, 9},
                {3, 9, 6, 5, 7, 13, 0, 12, 15, 1, 4, 2, 11, 8, 14, 10},
                {4, 11, 9, 7, 2, 14, 15, 5, 10, 6, 12, 3, 0, 13, 1, 8},
                {5, 14, 3, 13, 11, 10, 12, 7, 2, 8, 0, 1, 9, 15, 6, 4},
                {1, 2, 0, 8, 6, 3, 13, 4, 9, 11, 14, 15, 10, 12, 5, 7},
                {6, 10, 15, 12, 9, 0, 8, 1, 13, 7, 5, 4, 3, 14, 11, 2}};
